...
import Row from 'muicss/lib/react/panel';
import Button from 'muicss/lib/react/panel';
  ...
  return (
    ...
    <div className="App">
        <div className="mui-container-fluid">
          ...
          <div className="mui--text-white mui--text-display3" >Sulai Sivadel</div>
          <div className="mui--text-white mui--text-display2">Web Developer</div>
          ...
          &emsp;
            <Button color="danger"><a href="https://github.com/Sulai3030">Github</a></Button> 
            <Button color="danger"><a href="https://www.linkedin.com/in/sulai3030/">LinkedIn</a></Button>
            <Button color="danger"><a href={`mailto:${'sulai3030@gmail.com'}`}> Contact Me</a></Button>{' '}
        </div>
