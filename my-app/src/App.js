...
function App() {
  return (
    <div className="App"><Jumbotron fluid style={{backgroundColor: '#1fa8cc', color:'#FFC517', textAlign: 'left', textWidth:'80%', textPadding:'50px', padding: '20px'}}>
        <Container fluid>
      ...
      <Row>
        <Col sm={4}>
          <Card>
            ...
            <CardBody body inverse style ={{ backgroundColor: '#6994B3', borderColor: '#800',color:'#FFF', padding: '20px' }}>
              <CardTitle body inverse style={{color:'#FFA6A6', width:'250px', border:'50px'}}>RuneSkype</CardTitle>
        ...
        <Col sm={4}>  
            <Card>
              <CardImg top width="100%" src="https://placeholdit.imgix.net/~text?txtsize=33&txt=256%C3%97180&w=256&h=180" alt="" />
              <CardBody body inverse style={{ backgroundColor: '#6994B3', borderColor: '#800',color:'#FFF', padding: '20px'}}>
                <CardTitle body inverse style={{color:'#FFA6A6'}}>The G.O.A.T. Voter App!</CardTitle>
                <CardSubtitle></CardSubtitle>
        ...
        <Col sm={4}>  
            <Card>
              <CardImg top width="100%" src="https://placeholdit.imgix.net/~text?txtsize=33&txt=256%C3%97180&w=256&h=180" alt="" />
              <CardBody body inverse style={{ backgroundColor: '#6994B3', borderColor: '#800',color:'#FFF', padding: '20px'}}>
                <CardTitle body inverse style={{color:'#FFA6A6'}}>Mongo Scraper</CardTitle>
                <CardSubtitle></CardSubtitle>
        ...
        <Col sm={4}>  
            <Card>
              <CardImg top width="100%" src="https://placeholdit.imgix.net/~text?txtsize=33&txt=256%C3%97180&w=256&h=180" alt="" />
              <CardBody body inverse style={{ backgroundColor: '#6994B3', borderColor: '#800',color:'#FFF', padding: '20px'}}>
                <CardTitle body inverse style={{color:'#FFA6A6'}}>LIRI Bot Excercise</CardTitle>
                <CardSubtitle></CardSubtitle>
                ...
                https://github.com/Sulai3030/liriNodeApp
              <a href = "https://github.com/Sulai3030/RuneSkype"><Button variant="warning">Read More</Button></a>
              </CardBody>
            </Card>      
        </Col>
            <Card>
              <CardImg top width="100%" src="https://placeholdit.imgix.net/~text?txtsize=33&txt=256%C3%97180&w=256&h=180" alt="" />
              <CardBody body inverse style={{ backgroundColor: '#6994B3', borderColor: '#800',color:'#FFF', padding: '20px'}}>
                <CardTitle body inverse style={{color:'#FFA6A6'}}>My Old Blog</CardTitle>
                <CardSubtitle></CardSubtitle>
      ...
      <Col flexGrow={1}>
        <Row vertical="center">
          ...
          <Card>    
            ...
            <CardBody body inverse style={{ backgroundColor: '#6994B3', borderColor: '#800',color:'#FFF', padding: '20px', fontfamily: 'Roboto'}}>
              <CardTitle body inverse style={{color:'#FFA6A6'}}>Beer Near Here</CardTitle>
              <CardSubtitle></CardSubtitle>
        ...
        <Col sm={4}>  
            <Card>
              <CardImg top width="100%" src="https://placeholdit.imgix.net/~text?txtsize=33&txt=256%C3%97180&w=256&h=180" alt="" />
              <CardBody body inverse style={{ backgroundColor: '#6994B3', borderColor: '#800',color:'#FFF', padding: '20px'}}>
                <CardTitle body inverse style={{color:'#FFA6A6'}}>NYT React Excercise</CardTitle>
                <CardSubtitle></CardSubtitle>
          ...
          <Col sm={4}>  
            <Card>
              <CardImg top width="100%" src="https://placeholdit.imgix.net/~text?txtsize=33&txt=256%C3%97180&w=256&h=180" alt="" />
              <CardBody body inverse style={{ backgroundColor: '#6994B3', borderColor: '#800',color:'#FFF', padding: '20px'}}>
                <CardTitle body inverse style={{color:'#FFA6A6'}}>Firebase Assignment</CardTitle>
                <CardSubtitle></CardSubtitle>
          ...
          <Card>
              <CardImg top width="100%" src="https://placeholdit.imgix.net/~text?txtsize=33&txt=256%C3%97180&w=256&h=180" alt="" />
              <CardBody body inverse style={{ backgroundColor: '#6994B3', borderColor: '#800',color:'#FFF', padding: '20px'}}>
                <CardTitle body inverse style={{color:'#FFA6A6'}}>Giphy API Assignment</CardTitle>
                <CardSubtitle></CardSubtitle>
