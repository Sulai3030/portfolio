...
function App() {
  return (
    ...
    <div>
      ...
      <CardDeck>
      <Card body inverse style={{ backgroundColor: '#6994B3', borderColor: '#800',color:'#FFF' }}>
        ...
        <CardHeader>RuneSkype</CardHeader>
          ...
          <CardFooter className="text-muted"><Button>Read More Here</Button></CardFooter>
        </CardBody>
      </Card>
      <Card>
        <CardImg top width="100%" src="https://placeholdit.imgix.net/~text?txtsize=33&txt=256%C3%97180&w=256&h=180" alt="" />
      ...
      <Card>
        <CardImg top width="100%" src="https://placeholdit.imgix.net/~text?txtsize=33&txt=256%C3%97180&w=256&h=180" alt="" />
        <CardBody body inverse style={{ backgroundColor: '#6994B3', borderColor: '##54a8d7', color:'#FFF' }}>
