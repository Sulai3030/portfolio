  ...
  return (
    <div className="App">
      <div className="mui-container-fluid">
        ...
        <div className="mui--text-left" style={{color: '#fff'}}>RuneSkype is our final project for the Columbia Coding Bootcamp. It is the newest and best way for you and your friends to interact while playing your favorite Role Playing Game (RPG).
              Getting Started
        ...
        <Row>
          <Col md={6}><div className="mui--text-accent mui--text-headline">
            ...
            <div className="mui--text-left" style={{color: '#fff'}}>The MongoScraper Assignment was an excercise that required us to employ Handlebars, MongoDB, NodeJs and a Heroku backend.</div>
          <br />
          ...
          <div className="mui--text-left" style={{color: '#fff'}}>The Firebase Assignment is a culmination of the first half of our learning utilizing HTML, CSS, JavaScript and Firebase. Also know as the Train Scheduuler assignment we were tasked with using Google's Firebase platform. Firebase allows you to store and sync data across all clients in realtime, and remains available when your app goes offline. The Firebase Realtime Database is a cloud-hosted database. Data is stored as JSON and synchronized in realtime to every connected client.</div>
          <br />
