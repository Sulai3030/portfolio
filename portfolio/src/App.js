...
function App() {
  return (
    <div className="App">
      ...
      <div className="mui--text-display3" style={{color: '#f3bb3d'}}>Sulai Sivadel : Web Developer</div>
      <div className="mui--text-left mui--text-white" style={{backgroundColor: '#444', padding:'20px'}}>Ambitious, user-focused Full Stack Web Developer recently graduated from Columbia University Coding Boot Camp with experience working in teams. Possesses project management experience and experience delegating responsibilities to a team from time at Maximus where he spearheaded a project to create the audio/ADA compliant portion of a new healthcare plan for the disabled distributed in the state of New York. Sulai is flexible and a quick learner. Sulai is adaptable, communicative, knowledgeable and steadfast with excellent computer engineering skills learned in the Columbia University Coding Bootcamp where he created projects in HTML5, CSS, JavaScript, and React. Samples can be found below.</div>
        <Panel><a href="https://github.com/Sulai3030">GitHub</a>
        </Panel>
        <Panel><a href="https://www.linkedin.com/in/sulai3030/">LinkedIn</a>
        </Panel>
        <Panel><a href={`mailto:${'sulai3030@gmail.com'}`}>Contact Me!</a>
        </Panel>
        <Row>
          <Col xs={6}><div className="mui--text-accent mui--text-headline">RuneSkype</div>
          <div className="mui--text-left mui--text-white" style={{backgroundColor: '#444', padding:'20px'}}>RuneSkype is our final project for the Columbia Coding Bootcamp. It is the newest and best way for you and your friends to interact while playing your favorite Role Playing Game (RPG).
              Getting Started
        ...
        <Row>
          <Col md={6}><div className="mui--text-accent mui--text-headline">
            ...
            <div className="mui--text-left mui--text-white" style={{backgroundColor: '#444', padding:'20px'}}>The MongoScraper Assignment was an excercise that required us to employ Handlebars, MongoDB, NodeJs and a Heroku backend.</div>
          <br />
              <a href="https://github.com/Sulai3030/mongoScraper">Read More</a>
          </Col>
          <Col md={6}><div className="mui--text-accent mui--text-headline">Using Firebase as a Backend Project</div>
          <div className="mui--text-left mui--text-white" style={{backgroundColor: '#444', padding:'20px'}}>The Firebase Assignment is a culmination of the first half of our learning utilizing HTML, CSS, JavaScript and Firebase. Also know as the Train Scheduuler assignment we were tasked with using Google's Firebase platform. Firebase allows you to store and sync data across all clients in realtime, and remains available when your app goes offline. The Firebase Realtime Database is a cloud-hosted database. Data is stored as JSON and synchronized in realtime to every connected client.</div>
          <br />
